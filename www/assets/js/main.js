...
define('text!modules/StreamView/SpeciesView/SpeciesTemplate.html',[],function () { return '<span class="statusIcon">\r\n    <svg preserveAspectRatio="xMidYMid meet" width="16" height="16"\r\n         viewBox="0 0 16 16" version="1.1"\r\n         xmlns="http://www.w3.org/2000/svg" class="species">\r\n        <g>\r\n            <g class="{{species.brownTrout.name}}">\r\n                <circle class="population {{species.brownTrout.getPopulationClassName()}}" cx="4" cy="12" r="2.5"/>\r\n                <circle class="stocking {{species.brownTrout.getIsStockedClass()}}" cx="4" cy="12" r="2.7"/>\r\n            </g>\r\n\r\n            <g class="{{species.brookTrout.name}}" >\r\n                <circle class="population {{species.brookTrout.getPopulationClassName()}}" cx="12" cy="12" r="2.5"/>\r\n                <circle class="stocking {{species.brookTrout.getIsStockedClass()}}" cx="12" cy="12" r="2.7"/>\r\n            </g>\r\n\r\n            <g class="{{species.rainbowTrout.name}}">\r\n                <circle class="population {{species.rainbowTrout.getPopulationClassName()}}" cx="8" cy="5.0718" r="2.5"/>\r\n                <circle class="stocking {{species.rainbowTrout.getIsStockedClass()}}" cx="8" cy="5.0718" r="2.7"/>\r\n            </g>\r\n        </g>\r\n    </svg>\r\n  <!--<img src="assets/images/iconThing.png" >-->\r\n</span>';});
...
define('modules/StreamView/StreamLineView/StreamLineDirective',['require','../StreamSummaryModule','text!./StreamLineTemplate.html','ViewModels/StreamLineViewModel','ViewModels/LinearReferenceSegment','../../../ViewModels/RestrictionSummaryViewModel','d3'],function(require) {
...
define('modules/services/ServicesModule',['require','angular'],function(require) {
...
define('modules/services/BaseService',['require','./ServicesModule'],function(require) {
...
define('modules/services/StreamService',['require','./ServicesModule','./BaseService','ViewModels/StreamLine'],function(require) {
...
define('modules/services/SpecialRegulationsService',['require','./ServicesModule','./BaseService'],function(require) {
...
define('modules/services/EasementService',['require','./ServicesModule','./BaseService'],function(require) {
