...
define(function(require) {
     ...
     * @constructor
     */
    var StreamListView = function($element) {
        /**
     ...
     * @private
     */
    StreamListView.prototype.init = function() {
        this.setupHandlers()
           .createChildren()
           .layout()
           .enable();
     ...
     * @private
     */
    StreamListView.prototype.setupHandlers = function() {
     ...
     * @private
     */
    StreamListView.prototype.createChildren = function() {
     ...
     * @public
     */
    StreamListView.prototype.removeChildren = function() {
        this.$card = null;
     ...
     * @public
     */
    StreamListView.prototype.layout = function() {
        return this;
    };
     ...
     * @public
     */
    StreamListView.prototype.enable = function() {
        if (this.isEnabled) {
            return this;
        }
        this.isEnabled = true;
     ...
     * @public
     */
    StreamListView.prototype.disable = function() {
        if (!this.isEnabled) {
            return this;
        }
     ...
     * @public
     */
    StreamListView.prototype.destroy = function() {
        this.disable()
            .removeChildren();
     ...
     * @private
     */
    StreamListView.prototype.onClick = function(e) {
     ...
     * @private
     */
    StreamListView.prototype.onMouseEnter = function(e) {
     ...
     * @private
     */
    StreamListView.prototype.onMouseLeave = function(e) {
     ...
     * @private
     */
    StreamListView.prototype.onAfterFlip = function() {
